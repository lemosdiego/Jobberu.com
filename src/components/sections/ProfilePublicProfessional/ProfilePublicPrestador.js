...
export default function ProfilePublicPrestador({ profissional }) {
  ...
  return (
    <div className="w-[1200px] mt-8 mb-8">
      {/* Cabeçalho do Perfil */}
      ...
      <section className="mb-8">
        <h3 className="text-2xl font-semibold border-b pb-2 mb-4">Sobre mim</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {servicos_oferecidos.map((servico) => (
            <div key={servico.id} className="border rounded-lg p-4 shadow-md">
              ...
              <p className="text-sm text-gray-700 mb-3">{servico.descricao}</p>
